...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = get_user_model().objects.create_user('otheruser@example.com', 'otheruser123')
    ...
    def test_partial_update(self):
        """Test partial update on recipe API"""

        original_liink = 'https://example.com/recipe.pdf'
        ...
        self.assertEqual(recipe.link, original_liink)
        self.assertEqual(recipe.user, self.user)
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning exiting tag when updating recipe."""
    ...
    def test_filter_by_tags(self):
        """Test recipe filter by tags."""
        r1 = create_recipe(user=self.user, title='Thai vegetable curry')
        r2 = create_recipe(user=self.user, title='Augbegine with Tahini')
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken caiccetore')
